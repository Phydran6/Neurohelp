<div align="center">
<img src="assets/icons/app_icon.png" width="120" alt="Neurohelp">

# Neurohelp

### Eine App, die im Alltag hilft, ohne Druck zu machen

Für Menschen, denen Dinge schwerfallen,<br>
...
[![Download](https://img.shields.io/badge/Android-APK_herunterladen-3DDC84?style=for-the-badge&logo=android&logoColor=white)](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.10/Neurohelp-0.1.0-alpha.10-android.apk)
...
[![Plattform](https://img.shields.io/badge/Android%20%7C%20iOS-Flutter-02569B)](docs/TECHNIK.md)
...
**Du kannst ein eigenes KI-Konto verbinden**, kostenlos möglich, ein Tap in den
Einstellungen. Dann werden die Antworten besser, und die Texte gehen direkt von
deinem Gerät zum Anbieter, an unserem Server vorbei. Was dabei zu bedenken ist,
steht in der App direkt am Angebot und in [docs/KI-ZUGANG.md](docs/KI-ZUGANG.md).
...
| | Datei | Hinweis |
|:--|:--|:--|
| **Android** | [**APK herunterladen**](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.10/Neurohelp-0.1.0-alpha.10-android.apk) | Antippen, installieren, fertig |
| **iOS** | über **TestFlight** – Einladung auf Anfrage | Das IPA im Release ist ein App-Store-Build und lässt sich nicht sideloaden |
| **Play Store** | [AAB](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.10/Neurohelp-0.1.0-alpha.10-android-playstore.aab) | Nur zum Hochladen in die Play Console |
...
<sub>Aufbau, Entwicklung, Backend, Release-Prozess</sub>

<br><br>

<sub>[MIT-Lizenz](LICENSE) · © 2026 Philipp Fischer</sub>
