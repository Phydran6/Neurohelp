...
[![Download](https://img.shields.io/badge/Android-APK_herunterladen-3DDC84?style=for-the-badge&logo=android&logoColor=white)](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.7/Neurohelp-0.1.0-alpha.7-android.apk)
...
| | Datei | Hinweis |
|:--|:--|:--|
| **Android** | [**APK herunterladen**](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.7/Neurohelp-0.1.0-alpha.7-android.apk) | Antippen, installieren, fertig |
| **iOS** | über **TestFlight** – Einladung auf Anfrage | Das IPA im Release ist ein App-Store-Build und lässt sich nicht sideloaden |
| **Play Store** | [AAB](https://github.com/Phydran6/Neurohelp/releases/download/v0.1.0-alpha.7/Neurohelp-0.1.0-alpha.7-android-playstore.aab) | Nur zum Hochladen in die Play Console |
